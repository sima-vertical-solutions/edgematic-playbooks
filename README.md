...
| [`edgematic-stiga-tui-demo`](skills/edgematic-stiga-tui-demo) | Prepare a Stiga/ROSBOT board with Stiga's host tooling and verify its interactive operator TUI in EdgeMatic Studio. |
